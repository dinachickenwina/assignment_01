...
"""Calculates bill totals, tip amounts, and splits for group dining."""
...
def grand_total(subtotal, pct):
    """Return the subtotal plus the tip amount, rounded to the nearest cent.
...
def split_evenly(total, people):
    ...
    Raises:
        ValueError: If people is less than or equal to 0.
